...
a persistence unit "sample-jakartaee-ear-archetypePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sample-jakartaee-ear-archetype/pom.xml":
...
artifacts ("sample-jakartaee-ear-archetype-ejb.jar" and "sample-jakartaee-ear-archetype-web.war") are already built. You can build
